...
public class KamiPoPower extends AbstractPower {
    ...
    public KamiPoPower(AbstractCreature owner, int amount) {
 ...
 */
    ...
    public void on10(){
        ...
        //AbstractDungeon.actionManager.addToBottom(new ChannelAction(new KamiPoOrb()));
